    ...
    <div class="relative top-0 m-auto w-full h-full">
        <Container>
            <div class="flex flex-col justify-center items-center text-center">
                ...
                <NuxtLink
                    :to="button.to"
                    class="mt-10 bg-[rgba(0,0,0,0.2)] text-gray-300 hover:text-white hover:bg-[rgba(0,0,0,0.3)] backdrop-blur-md transition-all duration-300 py-3.5 px-8 rounded-2xl text-lg md:text-xl"
                >
                    {{ button.text }}
                </NuxtLink>
            </div>
